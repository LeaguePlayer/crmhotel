...
if($free_slots>0)
{
    ...
    'options'=>array(
        ...
        'select'=>"js:function(event, ui) {      
                  ...
                  $(this).next().next().val(ui.item.username);
                  $(this).next().next().next().val(ui.item.xyi);
    ...
    <?php echo CHtml::label('Имя',''); ?>
     ...
     <?php echo CHtml::hiddenField('users['.$i.'][id]','',array('size'=>40,'maxlength'=>40)); ?>
     <?php //echo CHtml::textField('users[4][phone]','',array('size'=>40,'maxlength'=>40)); ?>
