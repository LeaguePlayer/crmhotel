...
class PhonesController extends Controller
{
	...
	public function actionCreate($id_user)
	{
        ...
        if(isset($_POST['user']))
        {
            Clients::model()->updateByPk($_POST['user']['id'],array('name'=>$_POST['user']['name']));
        }
        elseif(isset($_POST['rowdelete']))
        {
            foreach ($_POST['rowdelete'] as $del)
            {
                Phones::model()->deleteByPk($del);
            }
        }
    ...
    $book = Phones::model()->findAll("id_client = $id_user");
    $user = Clients::model()->findByPk($id_user);
